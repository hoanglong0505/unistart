...
public class FieldTypeFacadeREST extends AbstractFacade<FieldType> {
    ...
    public void create(FieldType entity) {
        super.create(entity);
    }
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") Integer id, FieldType entity) {
        super.edit(entity);
    }
    ...
    public FieldType find(@PathParam("id") Integer id) {
    ...
    @Path("{from}/{to}")
    @Produces({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public List<FieldType> findRange(@PathParam("from") Integer from, @PathParam("to") Integer to) {
