...
public class EntranceInfoFacadeREST extends AbstractFacade<EntranceInfo> {
    ...
    private EntranceInfoPK getPrimaryKey(PathSegment pathSegment) {
         ...
         * URI path part is supposed to be in form of 'somePath;schoolId=schoolIdValue;fieldId=fieldIdValue;levelId=levelIdValue;year=yearValue'.
        ...
        java.util.List<String> levelId = map.get("levelId");
        if (levelId != null && !levelId.isEmpty()) {
            key.setLevelId(new java.lang.Integer(levelId.get(0)));
        }
